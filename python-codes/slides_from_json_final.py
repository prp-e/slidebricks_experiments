...
def apply_text_settings(text_frame, font_name, font_color, rtl):
    """Apply font settings and alignment to a text frame."""
...
def create_presentation_from_json(json_data):
    """Create a PowerPoint presentation from JSON data using default settings."""
    # Create a new presentation object with default settings
    ...
    presentation.save("comprehensive_presentation_new.pptx")
    print("Presentation created successfully with default settings!")
...
# Create the presentation using default settings
